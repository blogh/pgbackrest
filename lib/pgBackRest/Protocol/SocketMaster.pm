####################################################################################################################################
# PROTOCOL SOCKET MASTER MODULE
####################################################################################################################################
package pgBackRest::Protocol::SocketMaster;
...
sub new
{
    ...
    my $oIO = new pgBackRest::Protocol::IO($oSocket, $oSocket, undef, undef, $strId, $iProtocolTimeout, $iBufferMax);
